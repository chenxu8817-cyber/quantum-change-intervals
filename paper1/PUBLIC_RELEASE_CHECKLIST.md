...
- Suggested first immutable release tag: `v1.0.0-paper1`
...
neither item blocks the GitHub tag `v1.0.0-paper1`. Do not add an archival DOI
...
3. Create and push the immutable `v1.0.0-paper1` tag. Optionally enable the
