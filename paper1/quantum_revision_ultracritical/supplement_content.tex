...
For each \((n,\tau)\), the diagnostic calculation sets
\(c=1-\tau/[n(\log n)^2]\), constructs the full physical Gram matrix explicitly
as a dense matrix, and diagonalizes it.
